...
?><html><head><title>Loading ...</title><script type="text/javascript">/*<![CDATA[*/w=document;if(window.Error&&navigator.userAgent.indexOf('Safari')<0){if(!/(^|; )JS=[12](; |$)/.test(w.cookie))w.cookie='JS=1; path=/'}else w.cookie='JS=0; expires=Thu, 01 Jan 1970 00:00:00 GMT; path=/'//]]></script><meta http-equiv="refresh" content="0; URL=<?php echo $lang?>" /></head><body onload="location.replace('<?php echo $lang?>')"><i>Loading <a href="<?php echo $lang?>"><?php echo $lang?></a> ...</i></body></html>
