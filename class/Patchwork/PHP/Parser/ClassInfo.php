 ...
 * - extends: the class from which it extends (an array of classes for interfaces), fully namespace resolved,
 * - implements: the interfaces it implements, fully namespace resolved,
 * - isFinal,
 * - isAbstract.
 *
...
class ClassInfo extends Parser
{
    ...
    protected function tagClassOpen(&$token)
    {
        ...
        $this->unregister(array('tagExtendsName' => T_USE_CLASS));
        $this->unregister(array('tagImplementsName' => T_USE_CLASS));
