...
var PHPParser = Editor.Parser = (function() {
  ...
  function PHPLexical(indented, column, type, align, prev) {
  ...
  function parsePHP(input, basecolumn) {
    ...
    var lexical = new PHPLexical((basecolumn || 0) - 2, 0, "block", false);
    ...
    function pushlex(type){
      var result = function(){
        lexical = new PHPLexical(indented, column, type, null, lexical)
      };
      result.lex = true;
      return result;
    }
